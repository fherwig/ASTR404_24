...
* Kippenhahn & Weigert chapter 2.2 provides examples how to estimate the central temperature and pressure of a star given its mass and radius

It is very helpful to remember the stellar structure equations in terms of $dm/dr$ and $dP/dr$ which is easiest if one completely understands what each term means. 
